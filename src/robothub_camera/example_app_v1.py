...
from robothub_framework_v1 import BaseCameraDataProcessor, CameraDataProcessors, RobothubCameraApplication, LiveView, OakCamera, send_robothub_image_event
...
class MyApp(RobothubCameraApplication):
    ...
    def create_pipeline(self, oak: OakCamera, camera_data_processors: CameraDataProcessors):
        ...
        LiveView.create_live_view(oak=oak, component=rgb, title="rgb stream")  # oak would be redundant if CameraComponent saves the pipline in a class variable
